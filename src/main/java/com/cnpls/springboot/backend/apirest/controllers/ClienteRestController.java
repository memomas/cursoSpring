package com.cnpls.springboot.backend.apirest.controllers;
...
import com.cnpls.springboot.backend.apirest.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public Cliente update(@RequestBody Cliente cliente, @PathVariable Long id) {
		...
		return clienteService.Save(current);
	}
